 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const i=e(0);function n(A,t){void 0==t&&(t={}),void 0==t.alpha&&(t.alpha=i.DEFAULT_DIRECTIVITY_ALPHA),void 0==t.sharpness&&(t.sharpness=i.DEFAULT_DIRECTIVITY_SHARPNESS),this._context=A,this._lowpass=A.createBiquadFilter(),this._lowpass.type="lowpass",this._lowpass.Q.value=0,this._lowpass.frequency.value=.5*A.sampleRate,this._cosTheta=0,this.setPattern(t.alpha,t.sharpness),this.input=this._lowpass,this.output=this._lowpass}n.prototype.computeAngle=function(A,t){let e=i.normalizeVector(A),n=i.normalizeVector(t),s=1;if(this._alpha>i.EPSILON_FLOAT){let A=e[0]*n[0]+e[1]*n[1]+e[2]*n[2];s=1-this._alpha+this._alpha*A,s=Math.pow(Math.abs(s),this._sharpness)}console.log("in compute angle",e,n),this._lowpass.frequency.value=.5*this._context.sampleRate*s,console.log("in compute angle freq",this._lowpass.frequency.value)},n.prototype.setPattern=function(A,t){this._alpha=Math.min(1,Math.max(0,A)),this._sharpness=Math.max(1,t),this.computeAngle([this._cosTheta*this._cosTheta,0,0],[1,0,0])},A.exports=n},function(A,t,e){"use strict";
/**
 * @license
 * Copyright 2017 Google Inc. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
